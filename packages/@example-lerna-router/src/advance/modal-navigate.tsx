    ...
    >
      ...
      >
        <div className="article pane container">
          <p>
            Modal route which also called pane route is a route that will be rendered and not
            replace
          </p>
          <p>
            <i>
          ...
          <p>
            ...
            route you want to navigate to. <code>background</code> state is the current location.
            This is required because modal route will be rendered at bottom of the current page.
          </p>
